                ...
                >
                    ...
                    <div class="flex gap-3 text-sm leading-normal">
                        ...
                        <template v-else>
                            ...
                            <Link
                                href="/register"
                                class="inline-block rounded-sm border border-black/15 bg-transparent px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:bg-[#1b1b18]/5 dark:border-[#eeeeec]/20 dark:text-[#eeeeec] dark:hover:bg-[#eeeeec]/5"
                            >
                                Register
                            </Link>
                        </template>
